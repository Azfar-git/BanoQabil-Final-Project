...
import { Mail, Phone, MapPin, CheckCircle, Clock, Users, MessageCircle } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="space-y-8">
                {contactInfo.map((info, index) => (
                  ...
                  >
                    <div className="flex items-start space-x-4">
                      <div className={`w-12 h-12 rounded-lg bg-${info.color}-100 dark:bg-${info.color}-900/20 flex items-center justify-center`}>
                ...
                {/* Quick Support */}
                <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl p-6" data-aos="fade-up">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm opacity-90">Mon-Fri: 9 AM - 6 PM</div>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm opacity-90">Online & On-campus</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6 md:p-8" data-aos="fade-left">
              ...
              {/* Map */}
              <div className="mt-8 bg-white dark:bg-gray-900 rounded-xl shadow-lg overflow-hidden" data-aos="fade-up">
